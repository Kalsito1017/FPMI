...
Платформа за курсове и учебни материали за Факултета по приложна математика и информатика (ФПМИ)
към Пловдивски университет. ФПМИ Хъб позволява на студентите да разглеждат курсове,
да четат и създават уики страници с конспекти, да споделят ресурси и минали изпити,
да търсят в цялото съдържание и да дискутират в общността, докато служители и
модератори поддържат каталога чрез прост административен интерфейс.
...
Разпространява се под [MIT License](LICENSE) — Copyright (c) 2026 ФПМИ Хъб Contributors
